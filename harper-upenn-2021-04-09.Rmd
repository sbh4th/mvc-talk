...
.left[
## .orange[**1  Orientation: Bayesian thinking**]
## .gray[**2  Background: Seat belt laws**]
## .gray[**3  Methods**]
## .gray[**4  Results**]
## .gray[**5  Discussion**]
]
...
---
# Thought experiment
.footnote[See Hamra et al. (2013) for intuitive description of Bayesian inference, which I modified to this example.]
...
Source: [Government of Canada](https://www.canada.ca/en/services/policing/police/community-safety-policing/impaired-driving/drug-impaired-driving.html)
]
...
|**Prior probability**               |     |     |  
| :------------------------------------| :---:| :---: |  
| Initial estimate of how likely is X causes Y | $x$ | 20%    |  
| **A New Event Occurs: Your study**         |     |     |
| Probability of x conditional on H | $y$ | 20% |  
| Probability of x conditional on not H | $z$ | 10% |  
| **Posterior Probability**   |   |     |    
| New estimate of how likely H is to be true given X | $\frac{xy}{xy+z(1-x)}$ | 29% |  
...
.footnote[Source: [Toronto Star](https://www.thestar.com/news/gta/2015/11/26/clinical-study-at-camh-tests-how-cannabis-affects-volunteers-driving-skills.html) 2015-11-26.]
...
- Note the peak of the blue curve is the maximum likelihood estimate of 0.10.
]
.right-column[
.center[
...
- Inverse-weighting to reflect the amount of *information* given by the prior and likelihood.
...
- Revised estimate of the probability that cannabis affects crash probability.
]
.right-column[
.center[
...
- Now set a variable for which prior is constructed to 1 for the covariate of interest, as well as equivalent person-time based on prior. Save as dataset.
```stata
gen cov = 1 / 25
